...
<html>
<head>
    <base href="http://localhost/Laravel-User/">
    <meta charset="utf-8">
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="./user/signup" method="post" id="form-login" >
            {!! csrf_field() !!}
            ...
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Email Or PhoneNumber" name="email" id="email">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
            ...
            <div class="form-group has-feedback">
                <input type="checkbox" name="permission[]" value="1">Super Admin<br>
                <input type="checkbox" name="permission[]" value="2">Admin<br>
                <input type="checkbox" name="permission[]" value="3">Manager<br>
                <input type="checkbox" name="permission[]" value="4">Customer<br>
                <input type="checkbox" name="permission[]" value="5">post<br>
                <input type="checkbox" name="permission[]" value="6">update<br>
                <input type="checkbox" name="permission[]" value="7">delete<br>
            </div>
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button class="btn btn-primary btn-block btn-flat signup">Sign Up</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
